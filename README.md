...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-4%2C394%20rows-8250df">
...
> **Important:** this repository is a **public 4,394-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,622,088 domains** on the canonical page below.

**Public extract:** 4,394 rows · **Live catalog:** 5,622,088 domains
...
- `uk.csv` — public CSV extract (4,394 rows)
- `uk.json` — public JSON extract (4,394 rows)
...
| ----------------------- | ------------------------------------------------ |
| 4,394-row public sample | 5,622,088 live domains                           |
...
> Unique Domains. *Available .UK One-Word Domains*. Version 2026-04-10. Public GitHub extract for the exact Unique Domains search represented by this repository.
